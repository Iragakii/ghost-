...
// Note: meshline package removed - using standard Three.js geometry instead
// The lanyard band will use TubeGeometry as a fallback
  ...
  useFrame((state, delta) => {
    ...
    if (fixed.current) {
      ...
      if (band.current) {
        ...
        band.current.geometry = new THREE.TubeGeometry(newCurve, 32, 0.05, 8, false);
      }
